...
function refined_cscucmodel(
    ...
    open("D:/OneDriveFles/OneDrive/.uestc/AcademicResearchWorks/Prevoious Code/task 9/master-10 (little case - tuc vs cuc)/res/pro_calculation_result.txt", "w") do io
